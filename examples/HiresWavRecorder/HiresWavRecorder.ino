...
{
  Serial.begin(115200);
  Serial.println("Spresense Hi-res WAV Recorder");
  ...
  recorder.setFs(192000); /* change the default 48kHz to Hi-res 192kHz */
  ...
  player.setFs(192000); /* change the default 48kHz to Hi-res 192kHz */
...
void loop()
{
  const char *fname = "/mnt/sd0/hires.wav";
